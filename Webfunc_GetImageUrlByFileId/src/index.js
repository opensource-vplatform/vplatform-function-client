...
var getImageSrc = function(fileId) {
    if (fileId != null) {
        var result = "module-operation!executeOperation?operation=FileDown&token=%7B%22data%22%3A%7B%22dataId%22%3A%22" + fileId + "%22%2C%22ImageObj%22%3A%22" + fileId + "%22%7D%7D";
